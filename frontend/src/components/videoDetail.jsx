  ...
  const handleAddComment = (e) => {
    ...
    if (commentText.trim() && videoId) {
      ...
      .then(() => {
        ...
        dispatch(getVideoComments(videoId)); // Optionally refresh comments
      })
      .catch((error) => {
      ...
      <div className="border-t pt-4">
        ...
        {comments && comments.length > 0 ? (
          comments.map((commentItem, index) => {
            ...
            // Use fallback if owner or its properties are missing
              ...
              <div key={comment._id || index} className="mb-4">
                <div className="flex items-center mb-2">
                  <img
                    ...
                    alt={`${comment.userDetails?.username}'s avatar`}
